...
function Modal({ children, onClose }) {
  return (
    ...
    >
      <div className="bg-white p-10 rounded-lg w-4/5 max-w-4xl h-auto max-h-[95vh] overflow-y-auto relative shadow-lg">
        <button
    ...
    <>
      ...
      {openWeek && (
        <Modal onClose={() => setOpenWeek(false)}>
          ...
          <p className="text-lg text-gray-700 mb-6">{week1.desc}</p>
          ...
          <ul className="list-disc ml-6 mt-4 text-gray-700">
            ...
            <li className="text-lg font-medium">팀스파르타의 웹 디자이너</li>
          </ul>
        </Modal>
      )}
    </>
